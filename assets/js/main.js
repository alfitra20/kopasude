...
$(document).ready(function() {
	...
	function animateProgressBar(){
		...
		$(this).animateNumbers($(this).attr("data-value"), true, parseInt($(this).attr("data-animation-duration"), 1000));
...
function init() {
	...
	var mapOptions = {
		...
		center: new google.maps.LatLng(3.544876, 98.686127), // Kopasude
	...
	var marker = new google.maps.Marker({
		position: new google.maps.LatLng(3.544876, 98.686127),
		map: map,
		title: 'Kopasude'
	});
}
